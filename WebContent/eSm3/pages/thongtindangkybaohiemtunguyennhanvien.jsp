...
<%
	...
	String trangDanhSach = "index.jsp?p=eSm3/pages/thongtindangkybaohiemtunguyennhanviens.jsp";
...
<%
	...
	// kiểm tra xem đang truy cập vào trang đăng ký bằng link p=eSm3/pages/thongtindangkybaohiemtunguyennhanvien.jsp
	...
	if(p.equals("eSm3/pages/thongtindangkybaohiemtunguyennhanvien.jsp"))
		modeView =false;
