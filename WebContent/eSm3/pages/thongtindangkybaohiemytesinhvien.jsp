...
<%
	...
	String[] tk_value = { "maThongTinDangKyBaoHiemYTe", "dotDangKyBaoHiem", "thoiGianDangKy", "sinhVien",
			"coSoKhamChuaBenh" };
...
<%
	...
	// kiểm tra xem đang truy cập vào trang đăng ký bằng link p=eSm3/pages/thongtindangkybaohiemytesinhvien.jsp
	...
	if (p.equals("eSm3/pages/thongtindangkybaohiemytesinhvien.jsp"))
		modeView = false;

	ThongTinDangKyBaoHiemYTeSinhVien obj = null;
	if (session.getAttribute("obj") != null) {
		if (session.getAttribute("obj") instanceof ThongTinDangKyBaoHiemYTeSinhVien) {
			obj = (ThongTinDangKyBaoHiemYTeSinhVien) session.getAttribute("obj");
		}
	}
%>
<div class="row">
						...
						<div class="row">
							<div class="col-lg-6">
								<div class="form-group">
									<label>Mã thông tin đăng ký bảo hiểm y tế</label> <input
										class="form-control" name="maThongTinDangKyBaoHiemYTe"
								...
								<div class="form-group">
									...
									<%
										...
										ArrayList<DotDangKyBaoHiem> listDotDangKyBaoHiem = objdao.listByColumnLike("loaiBaoHiem", "Bảo hiểm y tế sinh viên");
