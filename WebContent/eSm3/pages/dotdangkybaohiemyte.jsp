...
<%
	...
	DotDangKyBaoHiemYTe obj = null;
	if (session.getAttribute("obj") != null) {
		if (session.getAttribute("obj") instanceof DotDangKyBaoHiemYTe) {
			obj = (DotDangKyBaoHiemYTe) session.getAttribute("obj");
		}
	}
%>
<div class="row">
							...
							<div class="col-lg-6">
								...
								<div class="form-group">
									...
									<select class="form-control" name="loaiBaoHiem"
										...
										%>
										<option
											<%=obj.getLoaiBaoHiem().equals("Bảo hiểm y tế nhân viên") ? "selected" : ""%>
											value="Bảo hiểm y tế nhân viên">Bảo hiểm y tế nhân
											viên</option>
										<option
											<%=obj.getLoaiBaoHiem().equals("Bảo hiểm y tế sinh viên") ? "selected" : ""%>
											value="Bảo hiểm y tế sinh viên">Bảo hiểm y tế sinh
											viên</option>
										<%
											} else {
										%>
										<option value="Bảo hiểm y tế nhân viên">Bảo hiểm y tế
											nhân viên</option>
										<option value="Bảo hiểm y tế sinh viên">Bảo hiểm y tế
											sinh viên</option>
										<%
											}
										%>
