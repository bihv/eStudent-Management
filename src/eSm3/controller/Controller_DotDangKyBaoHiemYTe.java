...
import eSm3.model.DotDangKyBaoHiemYTe;
import eSm3.modelDao.DAO_DotDangKyBaoHiemYTe;

public class Controller_DotDangKyBaoHiemYTe extends DotDangKyBaoHiemYTe implements ZEController {
	ObjectDAO dao = new DAO_DotDangKyBaoHiemYTe();

	String timKiemTheo;
	String tuKhoa;
	String duongDanTrang = "eSm3/pages/dotdangkybaohiemytes.jsp";
	String duongDanTrangView = "eSm3/pages/dotdangkybaohiemyte.jsp";
	...
	public String viewDetail() {
		...
		ArrayList<DotDangKyBaoHiemYTe> arr = dao.listByColumnLike(tenCotTimDoiTuong, maobj);
		if (arr.size() > 0) {
	...
	public String saveOrUpdate() {
		...
		DotDangKyBaoHiemYTe obj = new DotDangKyBaoHiemYTe();
	...
	public String search() {
		...
		ArrayList<DotDangKyBaoHiemYTe> arr = dao.listByColumnLike(column, key);
