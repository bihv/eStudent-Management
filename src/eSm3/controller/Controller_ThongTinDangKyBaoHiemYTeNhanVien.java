...
public class Controller_ThongTinDangKyBaoHiemYTeNhanVien extends ThongTinDangKyBaoHiemYTeNhanVien
		implements ZEController {
	ObjectDAO dao = new DAO_ThongTinDangKyBaoHiemYTeNhanVien();

	String timKiemTheo;
	String tuKhoa;
	String duongDanTrang = "eSm3/pages/thongtindangkybaohiemytenhanviens.jsp";
	String duongDanTrangView = "eSm3/pages/thongtindangkybaohiemytenhanvien.jsp";
	...
	public String saveOrUpdate() {
		...
		if (dao.saveOrUpdate(obj)) {
			...
			String content =  "<p>\r\n" + 
				...
				"<p>\r\n" + 
				"	<span class='im' style='font-family: arial, sans-serif; font-size: 12.8px;'><span style='font-size: 14px;'><span style='font-family: arial, helvetica, sans-serif;'>Ch&uacute;c mừng bạn đ&atilde; đăng k&yacute; th&agrave;nh c&ocirc;ng bảo hiểm y tế trong đợt đăng k&yacute;&nbsp;<span style='color:#ff0000;'>&quot;"+obj.getDotDangKyBaoHiem().getTenDotDangKyBaoHiem()+"&quot;</span>.</span></span></span></p>\r\n" + 
				"<p>\r\n" + 
